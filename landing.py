...
expert_db = {
    ...
    "차돌박이": {"title": "차돌박이, 얇은 슬라이스가 맛의 전부입니다", "desc": "기름이 많아 두께가 조금만 두꺼워도 질깁니다.", "points": ["두께 일관성", "지방 비율", "슬라이스 기술"], "parts": {"차돌": "고속 풍미"}, "strategy": "기름 튀지 않는 정교한 슬라이스"},
...
with col_a:
    ...
    with st.expander("📈 시세표 확인 (클릭)"):
        st.image("price.jpg", use_container_width=True) # 경고창 제거 완료
